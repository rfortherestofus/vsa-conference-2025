...
library(tidyverse)
tribble(~desc, ~lines,
        "Creating the dashboard itself", 3483,
        "Helper functions", 257,
        "Organizing & analyzing core survey data", 1107,
        "Specialized map visualizations", 222,
        "Custom visual of favorite animals", 100,
        "Specialized free response text analysis", 172,
        "Secondary survey data import", 153) |> 
  arrange(lines) |> 
